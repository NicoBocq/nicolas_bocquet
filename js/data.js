const PORTFOLIO_DATA = {
    projects: [
        {
            ...
            year: "2024",
            type: "E-COMMERCE",
            description: "Headless Shopify build with Next.js 14.",
            link: "#"
        },
        {
            title: "Analytics Pro",
            year: "2023",
            type: "DASHBOARD",
            description: "Real-time data visualization platform using D3.js.",
            link: "#"
        },
        {
            ...
            year: "2023",
            type: "EXPERIMENTAL",
            description: "Three.js exploration of 3D typography.",
            link: "#"
        }
    ],
    opensource: [
    ...
    skills: {
        ...
        ai: [
            "CLAUDE CODE CLI", "GEMINI", "CURSOR"
        ],
        soft: [
            "USER CENTRIC", "SHARP UX/UI & DESIGN EYE",
            "PROJECT OWNERSHIP & VISION", "HIGH QUALITY DELIVERY",
            "TEAM LEADERSHIP", "MENTORING", "PROBLEM SOLVING"
        ]
    },
    bio: {
        short: "Full Stack TypeScript Developer based in Marseille. Expert in React/Next.js ecosystem with a background in digital project management. Passionate about clean code, UX/UI, and product vision.",
    ...
    resume: {
        experience: [
            ...
            {
                role: "Digital Project Manager & Journalist",
                company: "La Provence",
                period: "Jun 2007 - Mar 2019",
                location: "Marseille",
                description: "12-year tenure evolving from Web Developer to Digital Lead.",
                details: [
        ...
        teaching: [
            {
                role: "Data Journalism Module Instructor",
                school: "Aix-Marseille University",
                period: "2014 - 2018"
            },
            {
                role: "Journalism & Social Media Module Instructor",
                school: "European Institute of Journalism (IEJ) Marseille",
                period: "2013 - 2015"
            }
        ]
    }
